...
function CreateFormPatient() {
  ...
  const [formData, setFormData] = useState({
    ...
    Filiere: 'Informatique', // Default to match first code
    Niveau: '',
    groupe_sanguin: '',
    sexe: '',
    taille: '',
    ...
    pression_arterielle: '',
    imc: '',
    categorie_imc: '', // Added to match first code
    fumeur: 'Non',
    nombre_cigarettes: '',
    chiqueur: 'Non',
  ...
  const handleSubmit = async (e) => {
    ...
    submissionData.set('Filiere', formData.Filiere || 'Informatique'); // Ensure correct case
    submissionData.set('Niveau', formData.Niveau || '1CP'); // Ensure correct case and default
