      ...
      <ul className="space-y-4 text-gray-700 font-medium">
        <li>
          <button
            ...
            className="flex items-center gap-3 w-full text-left px-2 py-2 rounded hover:bg-teal-200 text-teal-600"
          >
        ...
        <li>
          <button
            ...
            className="flex items-center gap-3 w-full text-left px-2 py-2 rounded hover:bg-teal-200"
          >
        ...
        <li>
          <button
            ...
            className="ml-4 text-left w-full text-sm px-2 py-2 rounded hover:bg-teal-100"
          >
            Maladies chroniques
          </button>
        </li>
