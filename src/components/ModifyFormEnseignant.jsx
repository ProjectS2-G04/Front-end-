  ...
  <div className="border rounded-lg shadow bg-white p-6 w-full h-full">
   ...
   <div className="grid grid-cols-2 gap-6 mb-4">
     <div>
        ...
        <input type="text" className="input-style" value={specialite} onChange={(e) => setSpecialite(e.target.value)} />

      </div>
      <div>
        <label className="block mb-1 font-medium">Grade</label>
        <input type="text" className="input-style" value={grade} onChange={(e) => setGrade(e.target.value)} />
